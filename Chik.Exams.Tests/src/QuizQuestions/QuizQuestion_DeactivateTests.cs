...
[TestFixture]
public class QuizQuestion_DeactivateTests
{
    ...
    [Test]
    public async Task Deactivate_WithExistingId_ShouldDeactivateQuestion()
    {
        // Arrange
        ...
        Assert.That(result!.DeactivatedAt, Is.Not.Null);
    }

    [Test]
    public async Task Deactivate_WithNonExistingId_ShouldThrowException()
    {
        // Act & Assert
        Assert.ThrowsAsync<KeyNotFoundException>(async () =>
            await _repository.Deactivate(99999));
    }
}
